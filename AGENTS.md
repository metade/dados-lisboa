...
This is the canonical source of truth for project-wide guidance. Agent-specific
instruction files should refer here rather than duplicate shared content.
